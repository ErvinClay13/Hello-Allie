  ...
  const getSmartAIResponse = async (prompt: string) => {
    try {
      ...
      if (match && match[1]) {
        ...
        const weatherRes = await fetch("https://hello-allie-backend.onrender.com/api/weather", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        return data.result || "Sorry, I couldn't fetch the weather.";
      }

      const sportsRes = await fetch("https://hello-allie-backend.onrender.com/api/sports", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      if (sportsData.result) {
        return sportsData.result;
      }

      const aiRes = await fetch("https://hello-allie-backend.onrender.com/api/generate", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      return aiData.result || "Sorry, I couldn't get a response.";
    } catch (error) {
