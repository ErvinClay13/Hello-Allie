// ✅ FINAL FULL VERSION: Home.screen.tsx — Android-compatible + Spanish & English Voice + Personalities
...
const HomeScreen = () => {
  ...
  const speak = (text: string, lang: string) => {
    Speech.stop();
    const voiceLang = lang === "es" ? "es-US" : "en-US";
    Speech.speak(text, {
      language: voiceLang,
  ...
  return (
    <LinearGradient colors={["#e7e9f7ff", "#c33764"]} style={styles.container}>
