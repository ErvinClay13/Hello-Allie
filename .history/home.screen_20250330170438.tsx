...
export default function HomeScreen() {
  ...
  const sendAudioToWhisper = async (uri: string) => {
    try {
      ...
      const response = await fetch('https://your-backend.onrender.com/api/transcribe', {
        method: 'POST',
        headers: {
  ...
  https://hello-allie-backend.onrender.com
  const getAIResponse = async (prompt: string) => {
    try {
      const response = await fetch('https://hello-allie-backend.onrender.com', {
        method: 'POST',
        headers: {
